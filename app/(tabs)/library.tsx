...
const styles = StyleSheet.create({
  ...
  filterChipActive: { backgroundColor: colors.textStrong, borderColor: colors.textStrong },
  ...
  likedArtwork: { backgroundColor: '#6266F2', alignItems: 'center', justifyContent: 'center', borderRadius: 12 },
  likedListArtwork: { width: 62, height: 62, borderRadius: 12, backgroundColor: '#6266F2', alignItems: 'center', justifyContent: 'center' },
  ...
  signIn: { height: 50, marginTop: 22, borderRadius: 15, backgroundColor: colors.textStrong, alignItems: 'center', justifyContent: 'center' },
